...
- (void)viewDidLoad
{
    ...
    self.ball = [[FHCrystalBall alloc] init];
    
    //We can create all the images using the UIImage (individuall) but it's easier to just create them in the array and voila
    //UIImage *image1 = [UIImage imageNamed:@"CB00001"];
    ...
    //Manually add the background image:
    ...
    */
    ...
    /*no longer needed as all these are now included in the FHCrystalBall class:
    ...
    self.predictions = [[NSArray alloc]initWithObjects: option1, option2, option3, option4, option5, option6, option7, nil ];
     */
     
    /*
    //The colors array, did it and it works but no longer needed
    //Create an array of UIColors in order to randomize the color of the text!
    ...
    self.colors = [[NSArray alloc]initWithObjects:red,blue,black,purple, yellow, nil];
    */
...
#pragma mark - Make Prediction Method

//The make prediction method (DRY don't repeat yourself)
-(void) makePrediction{
